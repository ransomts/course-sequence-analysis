...
core_biology_dhs_cips <- c(
  01.1203, 26.0100, 26.0101, 26.0102, 26.0200, 26.0202, 26.0203, 26.0204,
  26.0205, 26.0206, 26.0207, 26.0208, 26.0209, 26.0210, 26.0299, 26.0300,
  26.0301, 26.0305, 26.0307, 26.0308, 26.0399, 26.0400, 26.0401, 26.0403,
  26.0404, 26.0406, 26.0407, 26.0499, 26.0500, 26.0502, 26.0503, 26.0504,
  26.0505, 26.0506, 26.0507, 26.0508, 26.0509, 26.0599, 26.0700, 26.0701,
  26.0702, 26.0707, 26.0708, 26.0709, 26.0799, 26.0800, 26.0801, 26.0802,
  26.0803, 26.0804, 26.0805, 26.0806, 26.0807, 26.0899, 26.0900, 26.0901,
  26.0902, 26.0903, 26.0904, 26.0905, 26.0907, 26.0908, 26.0909, 26.0910,
  26.0911, 26.0912, 26.0913, 26.0999, 26.1000, 26.1001, 26.1002, 26.1003,
  26.1004, 26.1005, 26.1006, 26.1007, 26.1099, 26.1100, 26.1101, 26.1102,
  26.1103, 26.1104, 26.1199, 26.1200, 26.1201, 26.1300, 26.1301, 26.1302,
  26.1303, 26.1304, 26.1305, 26.1306, 26.1307, 26.1308, 26.1309, 26.1310,
  26.1311, 26.1399, 26.1400, 26.1401, 26.1500, 26.1501, 26.1502, 26.1503,
  26.1504, 26.1599, 26.9900, 26.9999, 27.0306, 30.0101, 30.0601, 30.1001,
  30.2701)

applied_biology_dhs_cips <- c(
  01.0901, 01.0902, 01.0903, 01.0904, 01.0905, 01.0906, 01.0907, 01.0999,
  01.1001, 01.1002, 01.1099, 01.1101, 01.1102, 01.1103, 01.1104, 01.1105,
  01.1106, 01.1199, 01.8105, 01.8106, 01.8107, 01.8108, 01.8109, 01.8110,
  01.8111, 03.0101, 03.0103, 03.0104, 03.0199, 03.0205, 03.0502, 03.0508,
  03.0509, 03.0601, 14.0300, 14.0301, 14.0500, 14.0501, 14.1400, 14.1401,
  14.3401, 14.4300, 14.4301, 14.4500, 14.4501, 15.0507, 30.1701, 30.1901,
  30.2501, 41.0101, 51.1005, 51.1401)

cips_of_interest <- geo_dhs_cips
```
...
# execution time on Tim's home server: 117 seconds = ~2 minutes
#course %<>% mutate(sequences = vectorized_format_courses(data))

# execution time on Tim's laptop: ~2.5 seconds
# execution time on Tim's home server: ~0.3 seconds
student_sequences_of_interest %<>% 
  mutate(sequences = vectorized_format_courses(data)) %>%
  collect()
toc()
```
...
TODO
Create a tibble with rows containing all courses taken by students in their first semester, second semester, etc. Bonus points if there is a paired tibble with how frequent each course was taken in each semester.
