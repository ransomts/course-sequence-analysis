...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(midfielddata)}
\CommentTok{\# Load multiple tables at once}
\FunctionTok{data}\NormalTok{(course, }\AttributeTok{package =} \StringTok{"midfielddata"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
